...
public class ConfigUtil {
    ...
    public Map<String, String> getUsers() throws IOException {
        ...
        synchronized (this) {
            ...
            String authenticationPath = Thread.currentThread().getContextClassLoader().getResource(configProperties.getAuthenticationPath()).getPath();
    ...
    public Set<String> getBlackList() throws IOException {
        ...
        synchronized (this) {
            ...
            String blacklistPath = Thread.currentThread().getContextClassLoader().getResource( configProperties.getBlacklistPath()).getPath();
